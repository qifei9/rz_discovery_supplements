...
# NOTE: change the path
sample_info <- read_xlsx("../../../demo/02_analysis/sample_info.xlsx")
...
peaks_chr_to_exclude <- bind_rows(peaks_chr9_to_exclude, peaks_chr13_to_exclude, peaks_chr22_to_exclude) |>
  select(peak_id) |>
  distinct()
